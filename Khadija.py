...
def passwrd():
	...
	print(f"\x1b[1;91m [😍] \x1b[1;92mYOUR NAME         \x1b[1;91m➢ \x1b[1;92m"+str(SHAMIM-NAME))
...
def RMX():
  ...
  id = "≠".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/ShamimCyber/KHADIJA/blob/main/Aproval.txt').text
    if id in httpCaht:
      msg = str(os.geteuid())
      time.sleep(0.3)
      login()
